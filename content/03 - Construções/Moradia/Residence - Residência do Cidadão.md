...
tipo: construção
nome: Residence
nome_pt: Residência do Cidadão
aliases: [Citizen's Hut, House]
categoria: Moradia
...
Antes de expandir a população, garanta vagas para os quatro cidadãos iniciais. Depois, vagas livres permitem crescimento; visitantes da Tavern também podem ser recrutados quando houver espaço.
...
- Agrupe moradias em rotas simples, não em becos apertados.
- Aproxime trabalhadores de seus empregos sem afastá-los demais da alimentação.
- Visualize o nível 5 para evitar sobreposição.
- Ilumine e proteja o trajeto noturno.
...
Verifique se os quatro iniciais já têm espaço, se há uma vaga adicional e se a geração de cidadãos está habilitada.
