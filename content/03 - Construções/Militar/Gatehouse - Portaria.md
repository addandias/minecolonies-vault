...
A Portaria é uma construção de acesso da colônia, pensada para marcar uma entrada e participar do sistema de conexões entre colônias. Seu papel é diferente do portão decorativo: ela é uma construção administrável do MineColonies, com interface e progressão próprias.
...
A Portaria acompanha a progressão de construções da colônia até o nível 5. As melhorias reforçam sua presença arquitetônica e devem permanecer compatíveis com o nível da Prefeitura.
...
A Portaria não deve ser confundida com os **Gates**, blocos móveis colocados em estruturas e muralhas. O portão controla fisicamente a passagem; a Portaria é a construção que organiza o acesso e a conexão.
