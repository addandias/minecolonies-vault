...
tipo: construção
nome: Combat Academy
nome_pt: Academia de Combate
categoria: Militar
trabalhador: Knight in Training
pesquisa: Improved Swords
...
| Frente | Traseira |
|---|---|
| ![[assets/construcoes/medieval-dark-oak/military/combatacademy/front.jpg]] | ![[assets/construcoes/medieval-dark-oak/military/combatacademy/back.jpg]] |

> [!INFO] Variante disponível
> O acervo também contém `military/altcombatacademy`.
...
O nível determina quantos alunos treinam ao mesmo tempo: de um no nível 1 até cinco no nível 5.
