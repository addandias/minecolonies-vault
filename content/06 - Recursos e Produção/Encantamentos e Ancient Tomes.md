...
tags: [minecolonies, encantamentos, ancient-tomes, magia, lote-8a]
---
...
```mermaid
flowchart LR
    A["Rotina dos trabalhadores"] --> B["Experiência observada"]
    B --> C["Enchanter"]
    D["Ancient Tome"] --> C
    C --> E["Livro encantado"]
    E --> F["Aplicação pelo jogador"]
```
...
> Ancient Tomes são uma entrada limitada e estratégica. Reserve-os no Armazém e acompanhe os livros obtidos antes de ampliar a produção. A melhor prioridade depende dos equipamentos e das ameaças enfrentadas pela colônia.
