...
Uma colônia recém-fundada começa com quatro cidadãos. Eles precisam de trabalho, moradia, comida e caminhos seguros.
...
Para acomodar os quatro cidadãos iniciais, você pode melhorar moradias existentes ou construir várias. O crescimento posterior também depende de vagas disponíveis.
...
- ilumine caminhos e áreas de trabalho;
- cubra buracos e ravinas;
- crie pontes onde necessário;
- evite água corrente e desníveis excessivos nas rotas;
- use **Recall** quando um cidadão ficar preso.
