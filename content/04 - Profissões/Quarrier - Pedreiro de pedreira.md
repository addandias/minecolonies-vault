...
- picaretas compatíveis com os blocos encontrados;
...
1. recebe a etapa atual do projeto;
2. solicita ferramentas e materiais necessários;
3. remove ou posiciona blocos conforme o esquema;
4. deposita os recursos obtidos no armazenamento da construção;
5. continua até concluir o volume planejado.
...
- [Quarry e Quarrier — Wiki oficial do MineColonies](https://minecolonies.com/wiki/buildings/quarry/)
