...
|---|---|---|
| Builder parado | Materiais, ferramenta, ordem e acesso | [[content/04 - Profissões/Builder - Construtor]] |
| Pedido não chega | Warehouse, Courier, rota e prioridade | [[content/06 - Recursos e Produção/Armazém e entregadores]] |
| Cidadãos com fome | Estoque, Dining Hall, distância e cardápio | [[content/05 - Alimentação/Sistema de fome]] |
...
| Mineiro não avança | Ferramenta, nível da Mine, acesso e pedidos | [[content/03 - Construções/Recursos/Mine - Mina]] |
...
3. confirme se o item existe no Warehouse;
4. confirme se existe Courier e rota transitável;
