...
Uma colônia avançada não é apenas grande: ela mantém produção, defesa e serviços com pouca intervenção do jogador e consegue absorver novos projetos sem colapsar as cadeias existentes.
...
- defesa em camadas;
- serviços de saúde, educação e felicidade dimensionados;
- produção mística e do Nether integrada.

## Organização por distritos
...
1. escolha um item comprado ou entregue manualmente com frequência;
2. localize sua receita na [[content/06 - Recursos e Produção/Matriz de receitas e oficinas]];
3. confirme pesquisa, oficina, trabalhador e entradas;
4. ensine a receita e defina estoque mínimo;
5. acompanhe pedidos e tempo de entrega;
6. revise o resultado antes de automatizar outra cadeia.
